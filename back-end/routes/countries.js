...
recordRoutes.route("/country").get(function (req, res) {
  let db_connect = dbo.getDb("countriesdata");
  db_connect
...
recordRoutes.route("/:id").delete((req, res) => {
  ...
  db_connect.collection("countriesdata").deleteOne(myquery, function (err, obj) {
    if (err) throw err;
